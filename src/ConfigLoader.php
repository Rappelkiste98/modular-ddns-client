...
class ConfigLoader
{
     ...
     */
    public static function loadIpDetector(string $detector, ?int $configPrefixLength, ?string $detectorURL, ?string $nic, ?string $ipv6Nic, ?string $username, ?string $password): IpDetector
    {
